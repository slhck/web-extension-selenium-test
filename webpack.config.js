...
console.info('Launching WebPack with the following options:');
console.log(`nodeEnv       = ${nodeEnv}`);
console.log(`targetBrowser = ${targetBrowser}`);
  ...
  nodeEnv === 'development'
    ? new ExtensionReloader({
        ...
        entries: {
          ...
          extensionPage: ['popup', 'options', 'app'],
        },
      })
    : () => {
        this.apply = () => {};
    ...
    rules: [
      ...
      },
      {
        ...
        use: [
          ...
          // FIXME: ^---- was commented out by WR due to build failure
